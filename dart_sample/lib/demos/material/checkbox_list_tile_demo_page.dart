...
class CheckboxListTileDemoPage extends StatefulWidget {
  const CheckboxListTileDemoPage({super.key});

  @override
  State<CheckboxListTileDemoPage> createState() =>
      _CheckboxListTileDemoPageState();
}

class _CheckboxListTileDemoPageState extends State<CheckboxListTileDemoPage> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        const Text(
          'Whole-tile interaction, tristate cycle, affinity, checkbox scaling, density/alignment, selected styling, disabled state, and the adaptive branch.',
        ...
        Text(
          'checkbox=$_checkboxValue, tristate=$_tristateValue, affinity=${_affinity.name}, adaptive=$_adaptive',
