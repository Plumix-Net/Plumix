...
| --- | --- | --- | --- |
 | `scrollbar.dart`, `magnifier.dart`, `text_selection_toolbar*.dart`, `desktop_text_selection_toolbar*.dart`, `spell_check_suggestions_toolbar.dart`, `adaptive_text_selection_toolbar.dart` | — | No missing public types; not re-verified member-by-member in this pass — diff against Dart when you touch them | — |
