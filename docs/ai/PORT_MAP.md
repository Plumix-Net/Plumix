...
| `material_ui/app_bar.dart` | `src/Plumix.Material/Scaffold.cs`<br>`src/Plumix.Material/SliverAppBar.cs` | `src/Plumix.Tests/MaterialScaffoldGeometryTests.cs`<br>`src/Plumix.Tests/MaterialScaffoldTests.cs`<br>`src/Plumix.Tests/MaterialSliverAppBarTests.cs` | `dart_sample/lib/demos/material/sliver_app_bar_demo_page.dart`<br>`src/Sample/Plumix.Sample/Demos/Material/SliverAppBarDemoPage.cs` |
...
| `material_ui/scaffold.dart` | `src/Plumix.Material/Scaffold.cs`<br>`src/Plumix.Material/ScaffoldGeometry.cs`<br>`src/Plumix.Material/ScaffoldLayout.cs`<br>`src/Plumix.Material/ScaffoldMessenger.cs` | `src/Plumix.Tests/MaterialScaffoldGeometryTests.cs`<br>`src/Plumix.Tests/MaterialScaffoldTests.cs` | — |
