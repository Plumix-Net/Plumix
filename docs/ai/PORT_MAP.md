...
- `src/Plumix/Widgets/Hero.cs` — (reference) (baseline subset)
...
- Flutter files mapped: 493
- C# files carrying a marker: 633
- C# files without a marker: 31
- Markers not resolvable in the pinned checkout: 0
- C# files with a qualified (non-strict) marker: 65
