...
| `material_ui/text_field.dart` | `src/Plumix.Material/TextField.cs` | `src/Plumix.Tests/CupertinoTextFieldTests.cs`<br>`src/Plumix.Tests/MaterialTextFieldTests.cs` | `dart_sample/lib/demos/cupertino/cupertino_text_field_demo_page.dart`<br>`dart_sample/lib/demos/material/text_field_demo_page.dart`<br>`src/Sample/Plumix.Sample/Demos/Cupertino/CupertinoTextFieldDemoPage.cs`<br>`src/Sample/Plumix.Sample/Demos/Material/TextFieldDemoPage.cs` |
...
| `widgets/text.dart` | `src/Plumix/Widgets/DefaultTextStyle.cs` _(reference) (approximate)_<br>`src/Plumix/Widgets/Text.cs` | `src/Plumix.Tests/CupertinoTextFieldTests.cs`<br>`src/Plumix.Tests/CupertinoTextFormFieldRowTests.cs`<br>`src/Plumix.Tests/CupertinoTextSelectionControlsTests.cs`<br>`src/Plumix.Tests/CupertinoTextThemeTests.cs`<br>`src/Plumix.Tests/DefaultTextEditingShortcutsTests.cs`<br>`src/Plumix.Tests/MaterialDesktopTextSelectionToolbarTests.cs`<br>`src/Plumix.Tests/MaterialTextFieldTests.cs`<br>`src/Plumix.Tests/MaterialTextSelectionControlsTests.cs`<br>`src/Plumix.Tests/MaterialTextSelectionThemeTests.cs`<br>`src/Plumix.Tests/TextInputServiceTests.cs`<br>`src/Plumix.Tests/TextInputTests.cs`<br>`src/Plumix.Tests/TextWidgetTests.cs` | `dart_sample/lib/demos/cupertino/cupertino_text_field_demo_page.dart`<br>`dart_sample/lib/demos/cupertino/cupertino_text_selection_controls_demo_page.dart`<br>`dart_sample/lib/demos/general/editable_text_demo_page.dart`<br>`dart_sample/lib/demos/general/rich_text_demo_page.dart`<br>`dart_sample/lib/demos/material/app_bar_text_styles_demo_page.dart`<br>`dart_sample/lib/demos/material/desktop_text_selection_toolbar_demo_page.dart`<br>`dart_sample/lib/demos/material/text_field_demo_page.dart`<br>`src/Sample/Plumix.Sample/Demos/Cupertino/CupertinoTextFieldDemoPage.cs`<br>`src/Sample/Plumix.Sample/Demos/Cupertino/CupertinoTextSelectionControlsDemoPage.cs`<br>`src/Sample/Plumix.Sample/Demos/General/EditableTextDemoPage.cs`<br>`src/Sample/Plumix.Sample/Demos/General/RichTextDemoPage.cs`<br>`src/Sample/Plumix.Sample/Demos/Material/AppBarTextStylesDemoPage.cs`<br>`src/Sample/Plumix.Sample/Demos/Material/DesktopTextSelectionToolbarDemoPage.cs`<br>`src/Sample/Plumix.Sample/Demos/Material/TextFieldDemoPage.cs` |
...
- Flutter files mapped: 482
- C# files carrying a marker: 620
