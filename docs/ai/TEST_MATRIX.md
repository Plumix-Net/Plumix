...
| Material popup menus | `src/Plumix.Tests/MaterialPopupMenuTests.cs` | Button/item contracts, M2/M3 item styling, theme/widget precedence, anchor/safe-area layout, shrink-wrap, selection/cancel lifecycle, keyboard traversal, and route semantics. | Checked/divider entries and cross-host golden verification of staged item animations. |
