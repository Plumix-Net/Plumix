...
| Material navigation surfaces | `src/Plumix.Tests/MaterialBottomNavigationBarTests.cs` | Item guards, fixed/shifting defaults, theme precedence, tap dispatch, tile semantics with localized index labels, tooltip hover. | Full shifting animation choreography. |
