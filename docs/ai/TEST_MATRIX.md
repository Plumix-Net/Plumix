...
| Dialog and AlertDialog | `src/Plumix.Tests/MaterialDialogTests.cs` | M2/M3/fullscreen defaults, theme precedence, view insets, intrinsic/text-scale/scroll/action layout, route barrier/reverse transition, semantics, and typed results. | Adaptive Cupertino path, root-navigator selection, and cross-host golden verification. |
