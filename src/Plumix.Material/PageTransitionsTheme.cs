...
{
    private readonly Plumix.Cupertino.CupertinoPageTransitionsBuilder _builder = new();

    internal static double BackGestureWidth =>
        Plumix.Cupertino.CupertinoPageTransitionsBuilder.BackGestureWidth;

    internal static double MinFlingVelocity =>
        Plumix.Cupertino.CupertinoPageTransitionsBuilder.MinFlingVelocity;

    internal static TimeSpan DroppedSwipePageAnimationDuration =>
        Plumix.Cupertino.CupertinoPageTransitionsBuilder.DroppedSwipePageAnimationDuration;

    public override TimeSpan TransitionDuration => _builder.TransitionDuration;

    public override DelegatedTransitionBuilder DelegatedTransition => _builder.DelegatedTransition;
    ...
    public override Widget BuildTransitions(
        ...
        Widget child)
    {
        return _builder.BuildTransitions(route, context, animation, secondaryAnimation, child);
    }
}
