            ...
            [
                ...
                new SliverFillViewport(
                    ...
                    @delegate: new SliverChildListDelegate(
                        [
                            BuildViewportPage("viewport page 1", new Color(0xFFE3F2FD)),
                            BuildViewportPage("viewport page 2", new Color(0xFFE8F5E9)),
                            BuildViewportPage("viewport page 3", new Color(0xFFFFF3E0)),
                        ],
                        addAutomaticKeepAlives: false)),
                new DecoratedSliver(
                    decoration: new BoxDecoration(
                        Color: new Color(0xFFEAF4FF),
                        Border: Plumix.Rendering.Border.FromBorderSide(new BorderSide(new Color(0xFF90CAF9), 2)),
