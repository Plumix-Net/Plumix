...
internal sealed class SampleGalleryScreen : StatelessWidget
{
    ...
    [
        ...
        new(
            SampleRoutes.MaterialIcons,
            "Icons",
            "full catalog: base/outlined/rounded/sharp variants + adaptive + directional glyphs",
            () => new MaterialIconsDemoPage()),
        new(
    ...
    [
        ...
        new(
            SampleRoutes.CupertinoIcons,
            "Icons",
            "legacy + SF Symbols catalog, aliases, and directional glyphs",
            () => new CupertinoIconsDemoPage()),
        new(
            SampleRoutes.CupertinoFocusHalo,
            "Focus halo",
        ...
        new(
            SampleRoutes.CupertinoMenuAnchor,
            "Menu anchor",
            "anchored overlay + leading/subtitle/trailing + swipe and long-press opening",
            () => new CupertinoMenuAnchorDemoPage()),
